...
"""
train : python run_no_lstm_model_v1.py --phase=train --batch_size=1 --lr=1e-4 --epoch=1000   --model=nolstm --architecture=ResnetBlock
test:   python run_no_lstm_model_v1.py --phase=test
...
def parse_args():
    ...
    parser.add_argument('--model', type=str, default='nolstm', help='model type: [lstm | gray | color |SE |nolstm]')
