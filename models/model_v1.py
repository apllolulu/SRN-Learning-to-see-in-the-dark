...
class DEBLUR(object):
    def __init__(self, args):
        ...
        #self.checkpoint_dir = './result_Sony_lstm_v1/'
        self.result_dir = './result_Sony_lstm_v1/'
        self.save_freq = 1000
            ...
            with slim.arg_scope([slim.conv2d, slim.conv2d_transpose],
                ...
                for i in range(self.n_levels):
                    ...
                    if self.args.architecture == 'ResnetBlock':
                        ...
                        if self.args.model == 'lstm':
                            deconv3_3, rnn_state = cell(conv3_3, rnn_state)
                        else:
                            deconv3_3 = conv3_3
    ...
    def build_model(self):
        ...
        # generator 计算多尺度损失
        x_unwrap = self.generator(img_in, reuse=tf.AUTO_REUSE, scope='g_net')  # False
        #print("x_unwrap[2].shape:", x_unwrap[2].shape)
        self.loss_total = 0
        for i in range(self.n_levels):
            # 逐层计算损失 MSE
    ...
    def test(self, height, width):
        ...
        result_dir = './result_Sony_lstm_v1/'# ./result_Sony_lstm_v1/
        # get test IDs
